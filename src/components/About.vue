        ...
        <section class="hero is-dark is-bold">
            <div class="hero-body">
                <div class="container">
                    ...
                    <h2 class="subtitle">This website serves as both a technical playground and a place to introduce myself.</h2>
                </div>
            </div>
        </section>
        <section class="container">
            <div class="content section">
                <p>I'm a software developer from Canada's west-coast with extensive experience building and maintaining web applications using modern frameworks and technology. Prior to entering the industry, I owned and operated a brick-and-mortar small business servicing local consumers. Switching gears (and career paths!) in 2014, I moved on the goal of combining a fanatic pursuit of continual process improvement and a strong passion for leveraging technology to achieve tangible results.</p>
